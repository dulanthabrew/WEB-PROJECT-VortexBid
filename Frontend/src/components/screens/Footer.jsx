...
const Footer = () => {
  return (
    <footer className="bg-[#00c0de] text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mt-4 md:mt-0">
            <div className="flex flex-wrap justify-center md:flex-nowrap">
              ...
              <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2">
                ...
                <ul className="mt-4 flex flex-col items-center md:flex-row space-y-2 md:space-y-0 md:space-x-4">
                  <li key="help-center">
                    <Link to="/help-center" className="hover:text-gray-950">
                      Help Center
                    </Link>
                  </li>
                  <li key="contact-us">
                    <Link to="/contact-us" className="hover:text-gray-950">
                      Contact Us
                    </Link>
                  </li>
                </ul>
        ...
        {/* Bottom section */}
        <div className="mt-8 text-center text-gray-950">
          <p>
            &copy; {new Date().getFullYear()} Vortex Bid. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
